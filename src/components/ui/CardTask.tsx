...
const CardTask = ({ name, select, ...props }: CardTaskProps) => {
  return (
    <div 
    className={`card min-w-48 min-h-24 bg-neutral-300 rounded-xl hover:bg-neutral-300/85 active:bg-neutral-200 ${select ? "border-[1px] border-primary-500 bg-neutral-400/50" : ""}`}
    {...props}
    >
